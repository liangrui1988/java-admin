...
<!-- 		   <div style="width:95%;float:left;" > -->
		   <table
	            id="summary_table" class="ui celled structured table span11" >
		    <thead>
		    <tr>
		    
		      <th  data-field="id" data-formatter="xuhao">序号</th>
	          <th  data-field="salesman.name">销售人员</th>
	          <th data-field="bonusAmount" data-sortable="true">总提成（元）</th>
	          <th data-field="sellBonus" data-sortable="true">当月售车提成（元）</th>
	          <th data-field="monthBonus" data-sortable="true">缴租提奖（元）</th>
	          <th data-field="halfYearBonus" data-sortable="true">半年提奖（元）</th>
	          <th data-field="salesNumber" data-sortable="true">当月销量（台）</th>
	          <!-- <th data-field="id" data-formatter="down" id="downth">下载列表</th> -->
	          <th data-colspan="8" data-field="id" data-formatter="down">下载</th>
