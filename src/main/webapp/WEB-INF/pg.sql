...
-- 战斗日志表
CREATE TABLE "public"."zl_log_info_main" (
...
WITH (OIDS=FALSE)
;
ALTER TABLE "public"."zl_log_info_main" OWNER TO "game";
CREATE INDEX "zl_log_info_main_file_index" ON "public"."zl_log_info_main" USING btree ("file" "pg_catalog"."text_ops");
CREATE INDEX "zl_log_info_main_server_index" ON "public"."zl_log_info_main" USING btree ("server_id" "pg_catalog"."int4_ops");
CREATE INDEX "zl_log_info_main_time_index" ON "public"."zl_log_info_main" USING btree ("time" "pg_catalog"."timestamp_ops");
CREATE INDEX "zl_log_info_main_time_log_index" ON "public"."zl_log_info_main" USING btree ("time_log" "pg_catalog"."int8_ops");
CREATE INDEX "zl_log_info_main_uuid_index" ON "public"."zl_log_info_main" USING btree ("uuid" "pg_catalog"."int8_ops");

--分表
create table zl_log_info2017_07
(CHECK (time >= DATE '2017-07-01' AND time< DATE '2017-08-01'))
INHERITS (zl_log_info);

create table zl_log_info2017_08(PRIMARY KEY ("id"))
...
-- 创建触发器
CREATE TRIGGER trigger_insert_zl_log_info_main BEFORE INSERT ON zl_log_info
FOR EACH ROW
